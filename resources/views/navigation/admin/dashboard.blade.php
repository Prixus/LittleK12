            ...
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <div>
                    <h2>Total Coordinator: {{$UserCount}}<small></small></h2>
                    </div>
                    <div>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                        <td>{{$Coordinator->User_FirstName . " " . $Coordinator->User_LastName}}</td>
                        <td>{{$Coordinator->User_ContactNumber}}</td>
                        <td>{{$Coordinator->User_Email}}</td>
                        <td>{{$Coordinator->User_Address}}</td>
                      </tr>
                        @endforeach
                      </tbody>
                    </table>
