                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$Subject->Subject_StartTime}}</td>
                          <td>{{$Subject->Subject_EndTime}}</td>
                          <td>{{$Subject->Subject_Description}}</td>
                          <td>
                            <button id="btnView" data-id="{{$Subject->id}}" data-code="{{$Subject->Subject_ID}}" data-name="{{$Subject->Subject_Name}}" data-year = "{{$Subject->Subject_Year}}" data-starttime = "{{$Subject->Subject_StartTime}}"  data-day="{{$Subject->Subject_Day}}" data-picture="{{$Subject->Subject_Picture}}" data-endtime = "{{$Subject->Subject_EndTime}}" data-description="{{$Subject->Subject_Description}}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </button>
                            @if($CurrentStudentInformation['id'] != $Subject->FK_StudentID)
                            <button id="btnEnroll" data-id="{{$Subject->id}}" data-code="{{$Subject->Subject_ID}}" data-name="{{$Subject->Subject_Name}}" data-year = "{{$Subject->Subject_Year}}" data-starttime = "{{$Subject->Subject_StartTime}}"  data-day="{{$Subject->Subject_Day}}" data-picture="{{$Subject->Subject_Picture}}" data-endtime = "{{$Subject->Subject_EndTime}}" data-description="{{$Subject->Subject_Description}}" class="btn btn-success btn-xs"><i class="fa fa-mortar-board"></i> Enroll </button>
                            @else
                              @if($Subject->Enrollment_Status == "Pending for Approval")
                              <p style="color:darkblue">Pending for coordinator's approval</p>
                              @else
                              <p style="color:green">Currently Enrolled</p>
                              @endif
                            @endif
                            <!-- <button id="btnEdit" data-id="{{$Subject->id}}" data-code="{{$Subject->Subject_ID}}" data-name="{{$Subject->Subject_Name}}" data-year = "{{$Subject->Subject_Year}}" data-starttime = "{{$Subject->Subject_StartTime}}" data-day="{{$Subject->Subject_Day}}" data-picture="{{$Subject->Subject_Picture}}"  data-endtime = "{{$Subject->Subject_EndTime}}" data-description="{{$Subject->Subject_Description}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </button>
                            <button id="btnDelete" data-id="{{$Subject->id}}" data-code="{{$Subject->Subject_ID}}" data-name="{{$Subject->Subject_Name}}" data-year = "{{$Subject->Subject_Year}}" data-starttime = "{{$Subject->Subject_StartTime}}" data-day="{{$Subject->Subject_Day}}" data-picture="{{$Subject->Subject_Picture}}"  data-endtime = "{{$Subject->Subject_EndTime}}" data-description="{{$Subject->Subject_Description}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </button></td> -->
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
