                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo e($Enrollment->User_FirstName . " " . $Enrollment->User_LastName); ?></td>
                          <td><?php echo e($Enrollment->Enrollment_Status); ?></td>
                          <td>
                          <button id="btnApprove" data-id="<?php echo e($Enrollment->PK_EnrollmentID); ?>"  data-code="<?php echo e($Enrollment->Subject_ID); ?>" data-name="<?php echo e($Enrollment->Subject_Name); ?>" data-studentname="<?php echo e($Enrollment->User_FirstName . " " . $Enrollment->User_LastName); ?>" data-status="<?php echo e($Enrollment->Enrollment_Status); ?>" class="btn btn-success btn-xs"><i class="fa fa-folder"></i> Approve Request </button>
                          </td>
                        </tr>
