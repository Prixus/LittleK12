...
<link href="../vendors/pnotify/dist/pnotify.nonblock.css" rel="stylesheet">
                    ...
                    <form class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="" required="required" value="{{$CurrentUserInformation['User_FirstName']}} {{$CurrentUserInformation['User_MiddleName']}} {{$CurrentUserInformation['User_LastName']}}" type="text" disabled>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="email" required="required" value="{{$CurrentUserInformation['User_Email']}}" disabled class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" id="birthdate" name="birthdate" data-validate-linked="birthdate" value="{{$CurrentStudentInformation['Student_DateOfBirth']}}" required="required" disabled class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select disabled id="gender" name="gender" required  class="form-control col-md-7 col-xs-12" value="{{$CurrentStudentInformation['Student_Gender']}}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text" id="address" name="address" required disabled value="{{$CurrentUserInformation['User_Address']}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="contact" type="text" disabled name="contact" data-validate-length-range="5,20" value="{{$CurrentUserInformation['User_ContactNumber']}}" class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">{{$Enrollment->PK_EnrollmentID}}</th>
                          <td>{{$Enrollment->Subject_ID}}</td>
                          <td>{{$Enrollment->Subject_Name}}</td>
                          <td>{{$Enrollment->Subject_Year}}</td>
                          <td>{{$Enrollment->Subject_Day}}</td>
                          <td>{{$Enrollment->Subject_Description}}</td>
                        </tr>
                        @endforeach
   ...
   <div class="modal fade bs-example-modal-lg" id="ModalEditProfile" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select  id="Gender" name="Gender" required  class="form-control col-md-7 col-xs-12" value="{{$CurrentStudentInformation['Student_Gender']}}">
                            <option value="Male">Male</option>
                            <option value="Female">Female</option>
                </select>
              </div>
  ...
  <script src="../vendors/pnotify/dist/pnotify.nonblock.js"></script>
    ...
    $(document).on('click','#EditStudentProfile',function(){
      $('#UserID').val('{{Session::get('CurrentUser')['id']}}');
      $('#FirstName').val('{{Session::get('CurrentUser')['User_FirstName']}}');
      $('#LastName').val('{{Session::get('CurrentUser')['User_LastName']}}');
      $('#MiddleName').val('{{Session::get('CurrentUser')['User_MiddleName']}}');
      $('#Birthdate').val('{{Session::get('CurrentStudent')['Student_DateOfBirth']}}');
      $('#Gender').val('{{Session::get('CurrentStudent')['Student_Gender']}}');
      $('#Address').val('{{Session::get('CurrentUser')['User_Address']}}');
      $('#ContactNumber').val('{{Session::get('CurrentUser')['User_ContactNumber']}}');
